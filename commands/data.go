...
func contractsErc20tokenSol() (*asset, error) {
	...
	info := bindataFileInfo{name: "contracts/ERC20Token.sol", size: 2337, mode: os.FileMode(420), modTime: time.Unix(1473208081, 0)}
...
func contractsTokenSol() (*asset, error) {
	...
	info := bindataFileInfo{name: "contracts/Token.sol", size: 3355, mode: os.FileMode(420), modTime: time.Unix(1473208405, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func contractsToken_testGo() (*asset, error) {
	...
	info := bindataFileInfo{name: "contracts/token_test.go", size: 2622, mode: os.FileMode(420), modTime: time.Unix(1473209419, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
