...
func contractsTokenGo() (*asset, error) {
	...
	info := bindataFileInfo{name: "contracts/token.go", size: 12295, mode: os.FileMode(384), modTime: time.Unix(1472428803, 0)}
...
func contractsTokenSol() (*asset, error) {
	...
	info := bindataFileInfo{name: "contracts/token.sol", size: 559, mode: os.FileMode(420), modTime: time.Unix(1472428801, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
